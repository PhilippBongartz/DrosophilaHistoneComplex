...
int main(int argc, char *argv[])
{
  ...
  char outputfile[]="SimulatedMSAreal";
  ...
  while(i<10000)
  {
    ...
    for(k=0;k<Tiefe;k++) 
    {
      ...
      if(newscore>oldscore || reihenscore>oldscore)
      {
