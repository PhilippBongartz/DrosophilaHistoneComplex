...
#
# This script is the correction part of TheanoNN.py
# It is used to start the correction if TheanoNN.py
# is running on several cores and all nets are already trained,
# but no single instance of TheanoNN.py has finished yet. 
# 
...
# Reading in the signatures and read information
if 1:
...
# Extending signatures with neighbouring bases
...
class Network(object):
	...
	def __init__(self,layersizes, activation_fn1=sigmoid, activation_fn2=sigmoid):
		...
		# double activation0[Max_Input];
		# double activation1[Max_Hidden];
		# double activation2[Max_Output];

		# double z0[Max_Hidden];
		# double z1[Max_Output];

		# self.a0 = T.dmatrix("a0") 
	...
	def SelftuningSGD(self, minibatchsize, trainingsdata, epochs, eta, lambd, selftuningstep):		
		...
		# Ich hatte nicht quadratic cost genommen, sondern L2
		#qcost = (((self.z2 - self.y)**2).sum()) * 0.5 + regularization #+ act_reg

		# Cross Entropy funktioniert nur mit Softmax-Output. t*log(y)+(1-t)log(1-y)
		# Nope, geht auch mit sigmoid.
